...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\OpenAPI\EbayFulFillmentClient\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \OpenAPI\EbayFulFillmentClient\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \OpenAPI\EbayFulFillmentClient\Model\ErrorParameter[]|null $parameters Contains a list of name/value pairs that provide additional information concerning this error or warning. Each item in the list is an input parameter that contributed to the error or warning condition.
     *
     * @return self
     */
