...
class IssueRefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'refund_items' => '\OpenAPI\EbayFulFillmentClient\Model\RefundItem[]',
        'order_level_refund_amount' => '\OpenAPI\EbayFulFillmentClient\Model\SimpleAmount'
    ];
     ...
     * Gets refund_items
     *
     * @return \OpenAPI\EbayFulFillmentClient\Model\RefundItem[]|null
     */
     ...
     * Sets refund_items
     *
     * @param \OpenAPI\EbayFulFillmentClient\Model\RefundItem[]|null $refund_items The refundItems array is only required if the seller is issuing a refund for one or more individual order line items in a multiple line item order. Otherwise, the seller just uses the orderLevelRefundAmount container to specify the amount of the refund for the entire order.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayFulFillmentClient\Model\SimpleAmount|null $order_level_refund_amount order_level_refund_amount
     *
     * @return self
     */
