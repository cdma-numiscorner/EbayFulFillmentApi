...
class ShippingFulfillment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets line_items
     *
     * @param \OpenAPI\EbayFulFillmentClient\Model\LineItemReference[]|null $line_items This array contains a list of one or more line items (and purchased quantity) to which the fulfillment applies.
     *
     * @return self
     */
