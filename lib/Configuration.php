...
namespace OpenAPI\EbayFulFillmentClient;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (OpenAPI\EbayFulFillmentClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.19.3' . PHP_EOL;
