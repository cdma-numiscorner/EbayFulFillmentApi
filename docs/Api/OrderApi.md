# OpenAPI\EbayFulFillmentClient\OrderApi
...
```php
getOrder($order_id, $field_groups): \OpenAPI\EbayFulFillmentClient\Model\Order
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\Order**](../Model/Order.md)
...
```php
getOrders($field_groups, $filter, $limit, $offset, $order_ids): \OpenAPI\EbayFulFillmentClient\Model\OrderSearchPagedCollection
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\OrderSearchPagedCollection**](../Model/OrderSearchPagedCollection.md)
...
```php
issueRefund($order_id, $issue_refund_request): \OpenAPI\EbayFulFillmentClient\Model\Refund
```
...
$issue_refund_request = new \OpenAPI\EbayFulFillmentClient\Model\IssueRefundRequest(); // \OpenAPI\EbayFulFillmentClient\Model\IssueRefundRequest
 ...
 **issue_refund_request** | [**\OpenAPI\EbayFulFillmentClient\Model\IssueRefundRequest**](../Model/IssueRefundRequest.md)|  | [optional]

### Return type

[**\OpenAPI\EbayFulFillmentClient\Model\Refund**](../Model/Refund.md)
