# OpenAPI\EbayFulFillmentClient\PaymentDisputeApi
...
$apiInstance = new OpenAPI\EbayFulFillmentClient\Api\PaymentDisputeApi(
...
$accept_payment_dispute_request = new \OpenAPI\EbayFulFillmentClient\Model\AcceptPaymentDisputeRequest(); // \OpenAPI\EbayFulFillmentClient\Model\AcceptPaymentDisputeRequest
 ...
 **accept_payment_dispute_request** | [**\OpenAPI\EbayFulFillmentClient\Model\AcceptPaymentDisputeRequest**](../Model/AcceptPaymentDisputeRequest.md)|  | [optional]
...
```php
addEvidence($payment_dispute_id, $add_evidence_payment_dispute_request): \OpenAPI\EbayFulFillmentClient\Model\AddEvidencePaymentDisputeResponse
```
...
$add_evidence_payment_dispute_request = new \OpenAPI\EbayFulFillmentClient\Model\AddEvidencePaymentDisputeRequest(); // \OpenAPI\EbayFulFillmentClient\Model\AddEvidencePaymentDisputeRequest
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to add evidence for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **add_evidence_payment_dispute_request** | [**\OpenAPI\EbayFulFillmentClient\Model\AddEvidencePaymentDisputeRequest**](../Model/AddEvidencePaymentDisputeRequest.md)|  | [optional]

### Return type

[**\OpenAPI\EbayFulFillmentClient\Model\AddEvidencePaymentDisputeResponse**](../Model/AddEvidencePaymentDisputeResponse.md)
...
$contest_payment_dispute_request = new \OpenAPI\EbayFulFillmentClient\Model\ContestPaymentDisputeRequest(); // \OpenAPI\EbayFulFillmentClient\Model\ContestPaymentDisputeRequest
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to contest. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **contest_payment_dispute_request** | [**\OpenAPI\EbayFulFillmentClient\Model\ContestPaymentDisputeRequest**](../Model/ContestPaymentDisputeRequest.md)|  | [optional]
...
```php
getActivities($payment_dispute_id): \OpenAPI\EbayFulFillmentClient\Model\PaymentDisputeActivityHistory
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\PaymentDisputeActivityHistory**](../Model/PaymentDisputeActivityHistory.md)
...
```php
getPaymentDispute($payment_dispute_id): \OpenAPI\EbayFulFillmentClient\Model\PaymentDispute
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\PaymentDispute**](../Model/PaymentDispute.md)
...
```php
getPaymentDisputeSummaries($order_id, $buyer_username, $open_date_from, $open_date_to, $payment_dispute_status, $limit, $offset): \OpenAPI\EbayFulFillmentClient\Model\DisputeSummaryResponse
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\DisputeSummaryResponse**](../Model/DisputeSummaryResponse.md)
...
$update_evidence_payment_dispute_request = new \OpenAPI\EbayFulFillmentClient\Model\UpdateEvidencePaymentDisputeRequest(); // \OpenAPI\EbayFulFillmentClient\Model\UpdateEvidencePaymentDisputeRequest
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to update the evidence set for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **update_evidence_payment_dispute_request** | [**\OpenAPI\EbayFulFillmentClient\Model\UpdateEvidencePaymentDisputeRequest**](../Model/UpdateEvidencePaymentDisputeRequest.md)|  | [optional]
...
```php
uploadEvidenceFile($payment_dispute_id): \OpenAPI\EbayFulFillmentClient\Model\FileEvidence
```
...
[**\OpenAPI\EbayFulFillmentClient\Model\FileEvidence**](../Model/FileEvidence.md)
